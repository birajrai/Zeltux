...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (member.roles.highest.position >= executor.roles.highest.position) {
      return interaction.reply({ content: 'You cannot ban this user as they have a higher or equal role.', ephemeral: true });
    }
    if (member.roles.highest.position >= botMember.roles.highest.position) {
      return interaction.reply({ content: 'I cannot ban this user as they have a higher or equal role than me.', ephemeral: true });
    }
    ...
    const banEmbed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: 'Duration', value: durationInMs ? prettyMs(durationInMs, { verbose: true }) : 'Permanent', inline: true }
      )
      .setTimestamp();
