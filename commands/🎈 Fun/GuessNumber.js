...
module.exports = {
            ...
            subcommand
                ...
                .addChannelOption((option) =>
                    option
                        .setName('channel')
                        .setDescription(
                            'The channel where the game will be hosted.'
                        )
                        .setRequired(true)
                )
            ...
            subcommand
                ...
                .addChannelOption((option) =>
                    option
                        .setName('channel')
                        .setDescription(
                            'The channel where the game is running.'
                        )
                        .setRequired(true)
                )
        ),
    ...
    async execute(interaction) {
        ...
        if (subcommand === 'start') {
            ...
            return channel.send(
                'The game has started! Start guessing the number!'
            )
        }
        ...
        if (subcommand === 'stop') {
            ...
            const stopEmbed = new EmbedBuilder()
                ...
                .setTitle('Guess the Number Game')
                .setDescription(
                    `The game in ${channel} has been stopped manually.`
                )
                .setTimestamp()
