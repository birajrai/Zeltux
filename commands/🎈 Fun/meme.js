    ...
    try {
      ...
      if (json && json.url) {
        ...
        const embed = new EmbedBuilder()
          ...
          .setImage(meme.url)
          .setFooter({ text: `Meme from r/${meme.subreddit} | Posted by ${meme.author} | Upvotes: ${meme.ups}` })
      ...
      await interaction.reply('There was an error trying to fetch a meme. Please try again later.');
    }
  },
};
