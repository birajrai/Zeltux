        ...
        switch (subcommand) {
                ...
                const claimMessage = messages.find(
                    (m) =>
                        ...
                        m.components[0].components.some(
                            (c) =>
                                c.customId === 'claim_ticket' ||
                                c.customId === 'view_claim'
                        )
                )
            ...
            case 'ban': {
                ...
                if (existingBan) {
                    return interaction.reply({
                        content:
                            '❌ This user is already banned from creating tickets!',
                        ephemeral: true,
                    })
                }
            ...
            case 'unban': {
                ...
                if (!existingBan) {
                    return interaction.reply({
                        content:
                            '❌ This user is not banned from creating tickets!',
                        ephemeral: true,
                    })
                }
            ...
            case 'remove': {
                ...
                if (
                    ...
                    return interaction.reply({
                        content:
                            '❌ This user does not have access to the ticket!',
                        ephemeral: true,
                    })
                }
