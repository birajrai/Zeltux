    ...
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option => 
            option.setName('language')
                .setDescription('The language to translate to (e.g., "es" for Spanish, "fr" for French)')
                .setRequired(true) 
        ),
        ...
        try {
            ...
            const translationEmbed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: 'Language', value: targetLanguage.toUpperCase(), inline: true }
                )
            ...
            await interaction.reply({ embeds: [translationEmbed], components: [row] });
        } catch (error) {
            console.error(error);
            await interaction.reply('An error occurred while trying to translate the text. Please try again.');
        }
    },
};
