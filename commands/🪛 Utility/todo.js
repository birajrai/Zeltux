...
module.exports = {
            ...
            subcommand
                ...
                .addStringOption((option) =>
                    option
                        ...
                        .setDescription(
                            'Set the new priority level: low, medium, high'
                        )
                        .setRequired(true)
                        .addChoices(
                            { name: 'Low', value: 'low' },
    ...
    async execute(interaction) {
        ...
        if (subcommand === 'add') {
            ...
            const priority =
                interaction.options.getString('priority') || 'medium'
            ...
            {
                const taskNumber =
                    interaction.options.getInteger('task_number') - 1
                const newPriority =
                    interaction.options.getString('new_priority')
                const todos = await Todo.find({ userId })
