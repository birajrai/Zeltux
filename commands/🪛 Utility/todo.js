    ...
    async execute(interaction) {
        ...
        if (subcommand === 'add') {
            ...
            const addEmbed = new EmbedBuilder()
                ...
                .addFields({ name: 'Instructions', value: 'Use `/todo view` to see all tasks.' })
            ...
            if (todos.length === 0) {
                const emptyEmbed = new EmbedBuilder()
                    ...
                    .setDescription('Your todo list is currently empty.\nUse `/todo add` to add a new task.')
                    .setTimestamp();
            ...
            const tasks = todos.map((todo, index) => {
                const timestamp = Math.floor(new Date(todo.dateAdded).getTime() / 1000); 
            ...
            const viewEmbed = new EmbedBuilder()
                ...
                .setFooter({ text: 'Use /todo complete [task_number] to mark a task as completed or /todo delete [task_number] to remove it.' })
                .setTimestamp();
            ...
            if (taskNumber < 0 || taskNumber >= todos.length) {
                const errorEmbed = new EmbedBuilder()
                    ...
                    .setDescription('The specified task number does not exist. Please check your list and try again.')
                    .setTimestamp();
            ...
            const deleteEmbed = new EmbedBuilder()
                ...
                .addFields({ name: 'Note', value: 'The task has been successfully removed from your todo list.' })
                .setTimestamp();
            ...
            const deleteAllEmbed = new EmbedBuilder()
                ...
                .setDescription(deleted.deletedCount > 0 
            ...
            const completeEmbed = new EmbedBuilder()
                ...
                .addFields({ name: 'Status', value: 'This task has been marked as completed.' })
                .setTimestamp();
            ...
            await interaction.reply({ embeds: [completeEmbed] });
        } else if (subcommand === 'priority') {
             {
                ...
                const priorityChangeEmbed = new EmbedBuilder()
                    ...
                    .addFields(
                        { name: 'Task Number', value: `${taskNumber + 1}`, inline: true },
                        { name: 'Status', value: 'Priority level updated successfully!', inline: true }
                    )
                    .setFooter({ text: 'Use /todo view to see the updated list.' })
                    .setTimestamp();
