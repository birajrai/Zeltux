...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (!response.ok) {
                return await interaction.reply('Could not find the definition. Please check the word and try again.');
            }
            ...
            const definitionEmbed = new EmbedBuilder()
                ...
                .setDescription(definitions.map((def, index) => `**${index + 1}.** ${def.definition}`).join('\n'))
