...
module.exports = {
    ...
    async interactionCreate(interaction) {
        ...
        try {
            ...
            const authorInput =
                interaction.fields.getTextInputValue('embed_author')
            const fieldsInput =
                interaction.fields.getTextInputValue('embed_fields')
            ...
            if (authorInput) {
                const [authorName, authorUrl, authorIconUrl] =
                    authorInput.split('|')
                embed.setAuthor({
                    name: authorName,
                    url: authorUrl || null,
            ...
            await interaction.reply({
                content:
                    'Error creating embed. Check your inputs and try again.',
                ephemeral: true,
            })
        }
    },
