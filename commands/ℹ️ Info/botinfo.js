...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const botInfoEmbed = new EmbedBuilder()
      ...
      .addFields(
        { name: 'Developer', value: '```elm\nRedolentHalo\n```', inline: true },
        { name: 'Servers', value: '```elm\n' + totalGuilds + '\n```', inline: true },
        { name: 'Users', value: '```elm\n' + totalMembers + '\n```', inline: true },
        { name: 'Uptime', value: '```elm\n' + uptime + '\n```', inline: true },
        { name: 'CPU Usage', value: '```elm\n' + cpuUsage + '%\n```', inline: true },
        { name: 'RAM Usage', value: '```elm\n' + memoryUsage + ' MB / ' + totalMemory + ' MB\n```', inline: true },
        { name: 'CPU Model', value: '```elm\n' + cpuModel + '\n```', inline: true },
        { name: 'Operating System', value: '```elm\n' + operatingSystem + '\n```', inline: true },
        { name: 'Created On', value: '```elm\n' + moment(client.user.createdAt).format('MMMM Do YYYY, h:mm:ss A') + '\n```', inline: true },
        { name: 'Library', value: '```elm\ndiscord.js v14\n```', inline: true }
      )
